            ...
            <div className="overLay py-32 bg-gradient-to-r from-primary-600/95 to-primary-600/40">
              <div className="container text-white space-y-4">
                ...
                <div className="space-x-4">
                  <button className="btn text-primary-600 border-2 border-gray-100 bg-white hover:bg-gray-200">Shop Now</button>
                  <button className="btn bg-transparent border-2 border-gray-100 text-white hover:bg-white hover:text-primary-600  ">View Deals</button>
                </div>
              </div>
            </div>
          </div>
